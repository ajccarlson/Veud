/*
  ...
  - You are about to drop the column `hiddenColumns` on the `Watchlist` table. All the data in the column will be lost.
...
INSERT INTO "new_Watchlist" ("columns", "createdAt", "description", "header", "id", "name", "ownerId", "position", "type", "updatedAt") SELECT "columns", "createdAt", "description", "header", "id", "name", "ownerId", "position", "type", "updatedAt" FROM "Watchlist";
