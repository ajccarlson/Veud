...
INSERT INTO "new_Watchlist" ("columns", "createdAt", "description", "displayedColumns", "header", "id", "name", "ownerId", "position", "type", "updatedAt") SELECT "columns", "createdAt", "description", "displayedColumns", "header", "id", "name", "ownerId", "position", "type", "updatedAt" FROM "Watchlist";
