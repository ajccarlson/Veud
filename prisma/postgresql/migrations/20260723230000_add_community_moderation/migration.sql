...
ALTER TABLE "User" ADD COLUMN "suspensionEndsAt" TIMESTAMP(3);
...
ALTER TABLE "ReviewComment" ADD COLUMN "moderatedAt" TIMESTAMP(3);
...
ALTER TABLE "MediaCollection" ADD COLUMN "moderatedAt" TIMESTAMP(3);
...
ALTER TABLE "CollectionComment" ADD COLUMN "moderatedAt" TIMESTAMP(3);
...
ALTER TABLE "ProfileComment" ADD COLUMN "moderatedAt" TIMESTAMP(3);
...
CREATE TABLE "ModerationAppealDraft" (
    ...
    CONSTRAINT "ModerationAppealDraft_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "ModerationReport" ADD CONSTRAINT "ModerationReport_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ModerationReport" ADD CONSTRAINT "ModerationReport_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ModerationReport" ADD CONSTRAINT "ModerationReport_appealOfActionId_fkey" FOREIGN KEY ("appealOfActionId") REFERENCES "ModerationAction"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "ModerationAction" ADD CONSTRAINT "ModerationAction_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ModerationAction" ADD CONSTRAINT "ModerationAction_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "ModerationReport"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ModerationAppealDraft" ADD CONSTRAINT "ModerationAppealDraft_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ModerationAppealDraft" ADD CONSTRAINT "ModerationAppealDraft_actionId_fkey" FOREIGN KEY ("actionId") REFERENCES "ModerationAction"("id") ON DELETE CASCADE ON UPDATE CASCADE;
