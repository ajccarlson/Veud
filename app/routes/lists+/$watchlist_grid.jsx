...
export const columnDefs = [
  ...
  { field: 'differencePersonal', headerName: 'Difference: Personal', valueSetter: params => {setterFunction(params)}, valueGetter: 'data.personal - ((data.story + data.character + data.presentation + data.sound + data.performance + data.enjoyment) / 6)', valueFormatter: params => {if (!params.value || params.value == "NULL" || params.value == 0) { return "" } else {return differenceFormatter(params.value)}}, flex: 1, resizable: false, minWidth: 70, maxWidth: 90, filter: 'agNumberColumnFilter', editable: false, cellClass: "ag-score-cell", cellStyle: function(params) { let scoreType = "Difference Personal"; return  scoreColor( { range: scoreRange(scoreType), score: params.value, type: scoreType } ) } },
  ...
  { field: 'differenceObjective', headerName: 'Difference: Objective', valueSetter: params => {setterFunction(params)}, valueGetter: 'data.personal - data.tmdbScore', valueFormatter: params => {if (!params.value || params.value == "NULL" || params.value == 0) { return "" } else {return differenceFormatter(params.value)}}, flex: 1, resizable: false, minWidth: 70, maxWidth: 90, filter: 'agNumberColumnFilter', editable: false, cellClass: "ag-score-cell", cellStyle: function(params) { let scoreType = "Difference Objective"; return  scoreColor( { range: scoreRange(scoreType), score: params.value, type: scoreType } ) } }
]
