...
export const columnDefs = [
  ...
  { field: 'genres', headerName: 'Finished Date', valueSetter: params => {setterFunction(params)}, flex: 1, resizable: false, minWidth: 100, maxWidth: 200, filter: "agSetColumnFilter" },
