...
const columnDefs = [
  ...
  { field: 'Story', flex: 1, minWidth: 52, maxWidth: 80, cellEditor: 'agNumberCellEditor', cellEditorParams: { min: 1, max: 10, precision: 1, step: 1, showStepperButtons: true }, cellClass: "ag-score-border-left-single", cellStyle: function(params) { let scoreType = "Default"; return scoreColor( { range: scoreRange(), score: params.value, type: scoreType } ) } },
  ...
  { field: 'Averaged', flex: 1, minWidth: 62, maxWidth: 90, editable: false, cellClass: "ag-score-border-left-double", cellStyle: function(params) { let scoreType = "Default"; return scoreColor( { range: scoreRange(), score: params.value, type: scoreType } ) } },
  ...
  { field: 'TMDB_Score', headerName: 'TMDB Score', flex: 1, minWidth: 55, maxWidth: 80, editable: false, cellClass: "ag-score-border-left-double", cellStyle: function(params) { let scoreType = "TMDB Score"; return  scoreColor( { range: scoreRange(scoreType), score: params.value, type: scoreType } ) } },
