...
const columnDefs = [
  ...
  { field: 'Difference_Personal', headerName: 'Difference: Personal', flex: 1, minWidth: 70, maxWidth: 90, editable: false, cellClass: "ag-score-cell", cellStyle: function(params) { let scoreType = "Difference Personal"; return  scoreColor( { range: scoreRange(scoreType), score: params.value, type: scoreType } ) } },
  ...
  { field: 'Difference_Objective', headerName: 'Difference: Objective', flex: 1, minWidth: 70, maxWidth: 90, editable: false, cellClass: "ag-score-cell", cellStyle: function(params) { let scoreType = "Difference Objective"; return  scoreColor( { range: scoreRange(scoreType), score: params.value, type: scoreType } ) } }
]
